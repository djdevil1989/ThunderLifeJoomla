...
<h1><?php echo JText::_('CREATE_ACCOUNT'); ?></h1>
...
<tr>
	<td colspan='2'>
	<input type='submit' class='button<?php echo $this->pageclass_sfx; ?>' value='<?php echo JText::_('CREATEINWORLDACCOUNT'); ?>' />
	</td>
</tr>
<?php if($this->ossettings['addons'] & 8): ?>
<tr>
	<td colspan='2'><br /><br /><?php echo JText::_('USER_OR'); ?><br /><br /><br /></td>
</tr>
<tr>
	<td colspan='2'><?php echo JText::_('DESCIDENTIFYINWORLD'); ?></td>
</tr>
<tr>
	<td colspan='2'>
