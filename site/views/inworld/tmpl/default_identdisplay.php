...
<tr>
	<td>
	<p><?php echo sprintf(JText::_('TERMINALCOMMANDTEXT'),$this->ossettings['identminutes']); ?>
	<table cellspacing='0' cellpadding='0' border='0'>
	<tr>
		<td><div class='identcommand<?php echo $this->pageclass_sfx; ?>'><?php echo $this->identcommand; ?></div></td>
	</tr>
	</table>
	<?php echo sprintf(JText::_('TERMINALCOMMANDTEXT2'),$this->ossettings['identminutes']); ?></p>
	</td>
</tr>
</table>
<?php echo JText::_('USER_OR'); ?><br /><br />
