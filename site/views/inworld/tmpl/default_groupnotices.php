...
<h2><a href='index.php?option=com_opensim&view=inworld&task=groupdetail&groupid=<?php echo $this->grouplist['groupid']; ?>&tmpl=component'><?php echo $this->grouplist['groupname']." ".JText::_('GROUPNOTICES'); ?></a></h2>
