...
<tr>
	...
	<td width='10'><input type='checkbox' name='checkTerminal[]' id='terminal_<?php echo $terminal['terminalKey']; ?>' value='<?php echo $terminal['terminalKey']; ?>' onClick='isChecked(this.checked);' /></td>
