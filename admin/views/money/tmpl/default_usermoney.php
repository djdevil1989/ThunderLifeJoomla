...
<br /><br />
<a href='index.php?option=com_opensim&view=money&filter.receiver=<?php echo $this->userdata['uuid']; ?>&filter.orname=or'><?php echo JText::_('JOPENSIM_MONEY_USER_TRANSACTIONS'); ?></a>